...
// LEGACY -- Hero de paridad estricta con web-nueva/, sustituido por el Hero
// definitivo (docs/HERO_REDESIGN_SPEC.md, aprobado 2026-07-26). Contenido
// preservado tal cual (no se borra nada, condición nº14 del encargo de
// implementación) pero deshabilitado en bloque: todos los selectores de
// aquí abajo ([data-reveal-line], .orb/data-loop-anim, tamaños de círculo
// 112/84px, aria-label "Explorar la experiencia", el orden de hijos de
// #inicio) describen la implementación ANTERIOR del Hero y ya no
// corresponden al DOM actual. Ver e2e/hero.spec.ts para los tests del
// Hero definitivo. Este archivo se actualiza o se retira cuando el nuevo
// Hero quede aprobado visualmente (oráculo propio, todavía pendiente).
test.describe.skip("LEGACY — Hero de paridad estricta (pre 2026-07-26)", () => {
